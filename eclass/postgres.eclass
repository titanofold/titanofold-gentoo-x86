...
# @DESCRIPTION:
# This variable is generated by this eclass. It contains a dependency
# string to be used in *DEPEND in your ebuild.
...
# Sets PG_CONFIG and PG_SLOT to one of the slots defined in
# POSTGRES_COMPAT and is installed on the host system. It should called
# in in pkg_setup() for single-slot ebuilds.
